...
: A targeted mass spectrometry acquisition strategy performed on triple quadrupole instruments, in which a predefined set of precursor ion to fragment ion transitions is monitored throughout the run. SRM refers to monitoring a single transition, while MRM refers to monitoring multiple transitions in parallel; the terms are often used interchangeably.

**PRM (Parallel Reaction Monitoring)**
: A targeted mass spectrometry acquisition strategy performed on high-resolution instruments, in which predefined precursor ions are isolated and fragmented, and all resulting fragment ions are recorded in a single high-resolution MS2 scan, rather than monitoring individual transitions as in SRM/MRM.
